...
-- Data Exploration
	-- How meny sales we have?
	SELECT COUNT(*) as total_sale FROM (retail_sales);

	-- How meny unique customers we have?
...
-- Data analysis and  Bsiness key problems & answers
